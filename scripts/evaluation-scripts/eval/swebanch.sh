...
INPUT_SOURCE=${INPUT_SOURCE:-${INPUT_PATH:-${INPUT_DIR:-"${HOME}/database/origin/swebench-origin-claude-opus4.7"}}}
PROVIDER=${PROVIDER:-anthropic}
MODEL_NAME=${MODEL_NAME:-Claude-Opus-4.7-low-thinking}
MODEL_TAG=${MODEL_TAG:-swebench-origin-claude-opus4.7_claude-opus-4.7-low-thinking-512-main}
REASONING_EFFORT=${REASONING_EFFORT:-}
OPENROUTER_REASONING_ENABLED=${OPENROUTER_REASONING_ENABLED:-}
OPENROUTER_CACHE_ENABLED=${OPENROUTER_CACHE_ENABLED:-}
INPUT_TAG=${INPUT_TAG:-}
RUN_NAME=${RUN_NAME:-swebench-origin-claude-opus4.7_claude-opus-4.7-low-thinking-512-main}
