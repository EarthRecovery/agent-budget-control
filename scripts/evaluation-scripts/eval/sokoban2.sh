...
MODEL_NAME=${MODEL_NAME:-Claude-Opus-4.6-low-thinking}
...
RUN_NAME=${RUN_NAME:-sokoban-origin-claude-opus-4-6-low-thinking-128-main_claude-opus-4-6-low-thinking-128-main}
RESULT_ROOT=${RESULT_ROOT:-"$PROJECT_ROOT/results/evaluation-scripts/eval"}
OUTPUT_DIR=${OUTPUT_DIR:-"$RESULT_ROOT/${RUN_NAME}"}
INPUT_JSON=${INPUT_JSON:-"${HOME}/database/origin/sokoban-origin-claude-opus-4-6-low-thinking-128-main/sokoban_api_eval_estimation_eval_estimation_dialogues.json"}
