...
RUN_NAME=${RUN_NAME:-newwarehouse-gemini3.1-low-thinking-main}
...
INPUT_SOURCE=${INPUT_SOURCE:-"${HOME}/database/origin/newwarehouse-gemini3.1/combined_gemini3.1-pro_128seeds_harsh.json"}
