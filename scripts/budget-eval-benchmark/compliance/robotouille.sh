...
CONTEXT_WINDOW_MODE=${CONTEXT_WINDOW_MODE:-full} # full | single_turn | limited_multi_turn
MAX_CONTEXT_WINDOW=${MAX_CONTEXT_WINDOW:--1} # -1 keeps full history, 1 keeps only current turn
