...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-sokoban_llama31_8b_existing_data}"
TASK="${TASK:-sokoban}"
DATA_FILE="${DATA_FILE:-$SCRIPT_DIR/sokoban_llama31_8b.jsonl}"
SOURCE_KIND="jsonl"
LEARNER_MODEL="${LEARNER_MODEL:-meta-llama/Llama-3.1-8B-Instruct}"
ROLLOUT_MODEL="${ROLLOUT_MODEL:-meta-llama/Llama-3.1-8B-Instruct}"
